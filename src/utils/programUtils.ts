...
export async function fetchMarketReserveInfo(honeyProgram: any, marketId: PublicKey): Promise<HoneyMarketReserveInfo[]> {
    // market info
...
export async function fetchReserve(client: HoneyClient, reserveInfo: HoneyMarketReserveInfo): Promise<TReserve> {
...
/**
 * @description inits keypair
 * @params keypair
 * @returns keypair
*/
export function loadWalletKey(keypair: any) {
    if (!keypair || keypair == '') {
...
/**
 * @description loads the honey program
 * @params walletKeyPair
 * @returns honeyProgram
*/
